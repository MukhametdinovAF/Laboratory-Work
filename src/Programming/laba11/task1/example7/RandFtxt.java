package Programming.laba11.task1.example7;
import java.io.*;
...
public class RandFtxt {
    ...
    try{
        ...
        f1.createNewFile();
        //        При вводе строк символ абзаца (нажатие Enter)
        //        имеет такой же размер в байтах, как и другие
        //        символы, и учитывается при вычислении размера
        //        файла
