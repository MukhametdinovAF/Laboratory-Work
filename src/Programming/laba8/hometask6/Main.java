...
//        Example6.getLengthForThree(head);
//
//        //Б) Найти среди чисел, которые делятся на 3, минимальное и максимальное
//значения и их номера и поменять их местами.

//        Example6.getMinAndMaxForThree(head);
//        Example6.toStringMethod("GetLengthForThree",head);
    }
}
